...
public final class TickEndTask {
    ...
    private TickEndTask start() {
        ...
        if (!Runnable.class.isAssignableFrom(TickEndTask.RUNNABLE_CLASS)) {
            ...
            registeredObject = Proxy.newProxyInstance(
            ...
            registeredObject = runnable;
        }

        TickEndTask.RUNNABLES.add(registeredObject);
        return this;
    }
    ...
    public void cancel() {
        ...
        TickEndTask.RUNNABLES.remove(registeredObject);
