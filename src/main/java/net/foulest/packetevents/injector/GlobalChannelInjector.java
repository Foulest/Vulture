...
import net.foulest.packetevents.event.impl.PlayerEjectEvent;
import net.foulest.packetevents.event.impl.PlayerInjectEvent;
import net.foulest.packetevents.injector.modern.early.EarlyChannelInjectorModern;
