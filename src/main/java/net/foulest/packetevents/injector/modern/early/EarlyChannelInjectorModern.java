 ...
 */
package net.foulest.packetevents.injector.modern.early;

import io.netty.channel.*;
import io.netty.channel.epoll.EpollSocketChannel;
import io.netty.channel.socket.nio.NioSocketChannel;
import net.foulest.packetevents.PacketEvents;
import net.foulest.packetevents.injector.EarlyInjector;
import net.foulest.packetevents.injector.modern.PlayerChannelHandlerModern;
import net.foulest.packetevents.injector.modern.PlayerDecodeHandlerModern;
import net.foulest.packetevents.packetwrappers.NMSPacket;
import net.foulest.packetevents.packetwrappers.WrappedPacket;
import net.foulest.packetevents.utils.list.ListWrapper;
