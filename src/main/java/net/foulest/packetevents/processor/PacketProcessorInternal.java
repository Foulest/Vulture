...
import net.foulest.packetevents.packettype.PacketState;
import net.foulest.packetevents.packettype.PacketType;
import net.foulest.packetevents.packetwrappers.NMSPacket;
import net.foulest.packetevents.packetwrappers.handshaking.setprotocol.WrappedPacketHandshakingInSetProtocol;
import net.foulest.packetevents.packetwrappers.login.in.start.WrappedPacketLoginInStart;
 ...
 * This class mainly manages channel caching and internal processing.
 * Do NOT use this class, it is only meant to be used internally.
 *
 * @author retrooper
